            ...
            AsyncTask<Void, Void, Void> task = new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... arg0) {
                    try {
                        ...
                        supply_status = Util.getdata(API.SUPPLY_STATUS+"login_id="+LoginActivity.login_id+"&password="+LoginActivity.password+"&access_level="+LoginActivity.access_area+"&access_date="+datee);
                        supply_status = supply_status.replaceAll("<[^>]*>", "");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    return null;
                ...
                protected void onPostExecute(Void result) {
                    ...
                    try {
                        JSONObject reader = new JSONObject(supply_status);
                        int rc = reader.getInt("rc");

                        //------------------------------Table----------------------------------------
                        TableLayout tl = (TableLayout) view.findViewById(R.id.supply_status);

                        // super.setContentView(sv);

                        tl.removeAllViews();
                        if (rc == 0) {
                            String daily_supply_data = reader.getString("resource");
                            JSONObject daily_supply_datsa= new JSONObject(daily_supply_data);
                            JSONArray main= daily_supply_datsa.getJSONArray("supply");
                            try {
                                //---------------------------Table Header-------------------------------------------

                                View v11 = new View(getActivity());
                                v11.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, 1));
                                v11.setBackgroundColor(Color.parseColor("#a8a8a8"));
                                tl.addView(v11);
                                ...
                                project.setText("Project"+  System.getProperty("line.separator") );
                                project.setTextColor(Color.parseColor("#87cefa"));
                                project.setPadding(50, 10, 0, 10);
                                project.setTextSize(16);
                                tr_head.addView(project);

                                /*TextView discom_id = new TextView(getActivity());
                                discom_id.setText("Discomm "+  System.getProperty("line.separator") + "Id");
                                discom_id.setTextColor(Color.parseColor("#87cefa"));
                                discom_id.setTextSize(16);
                                discom_id.setPadding(50, 10, 0, 10);
                                tr_head.addView(discom_id);

                                TextView discom = new TextView(getActivity());
                                discom.setText("Discomm "+  System.getProperty("line.separator"));
                                discom.setTextColor(Color.parseColor("#87cefa"));
                                discom.setTextSize(16);
                                discom.setPadding(50, 10, 0, 10);
                                tr_head.addView(discom);*/

                                TextView avg_less = new TextView(getActivity());
                                avg_less.setText("Avg Less"+  System.getProperty("line.separator") );
                                avg_less.setTextColor(Color.parseColor("#87cefa"));
                                avg_less.setTextSize(16);
                                avg_less.setPadding(50, 10, 0, 10);
                                tr_head.addView(avg_less);

                                TextView count = new TextView(getActivity());
                                count.setText("Count"+  System.getProperty("line.separator") );
                                count.setTextColor(Color.parseColor("#87cefa"));
                                count.setTextSize(16);
                                count.setPadding(50, 10, 0, 10);
                                tr_head.addView(count);
                                ...
                                for(int i=0; i<main.length(); i++) {
                                    ...
                                    String short_name=objects.getString("project");
                                    String discom_id_string=objects.getString("discom_id");
                                    String discom_string =objects.getString("discom");
                                    String avg_less_string=objects.getString("avg_less");
                                    String count_string=objects.getString("count");
                                /*    String total_eul_amount=objects.getString("total_eul_amount");
                                    ...
                                    labelName.setText(discom_string);
                                    ...
                                    labelinterruptionCount.setText(short_name);
                                    ...
                                    labellabelinterruptionDur.setText(discom_id_string);
                                   ...
                                   /* TextView labeltotal_eul_unit = new TextView(getContext());
                                    labeltotal_eul_unit.setText(discom_string);
                                    ...
                                    labeltotal_eul_rs.setText(avg_less_string);
                                    ...
                                    labelEUL11.setText(count_string);
                                ...
                                //---------------Total ROW-----------------------------------
                                JSONObject total= daily_supply_datsa.getJSONObject("total");
                                ...
                                TextView label_totalCount = new TextView(getActivity());
                                label_totalCount.setText(total.getString("count"));
                                label_totalCount.setPadding(50, 12, 0, 12);
                                label_totalCount.setTextSize(12);
                                label_totalCount.setTextColor(white);
                                tr_total.addView(label_totalCount);
                                ...
                                label_toaleul_amount.setTextSize(12);
                                ...
                                label_EUL1_AMOUNT.setTextSize(12);
                                ...
                                label_EUL2_AMOUNT.setTextSize(12);
                                ...
                                label_EUL3_AMOUNT.setTextSize(12);
                                ...
                                v111.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, 1));
                       ...
                       // super.setContentView(sv);
                        ...
                        if (rc == 0) {
                            ...
                            try {
                                ...
                                label_totalInterupt.setTextSize(12);
